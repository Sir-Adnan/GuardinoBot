...
INLINE_BUTTONS: dict[str, str] = {
    ...
    "nowpayments_pay_online": "💳 پرداخت آنلاین NowPayments",
    "nowpayments_check_payment": "🔄 بررسی وضعیت NowPayments",
    "nowpayments_cancel_invoice": "❌ لغو فاکتور NowPayments",
    "pay_swapino": "🪙 سواپینو",
    "pay_tronado": "🪙 ترون",
...
DEFAULT_STYLES: dict[str, str] = {
    ...
    "pay_plisio": "success",
    "pay_offline": "success",
    "pay_nowpayments_io": "success",
    "plisio_pay_online": "success",
    "plisio_check_payment": "success",
    "nowpayments_pay_online": "success",
    "nowpayments_check_payment": "success",
    "proxy_renew": "success",
    "renew_now": "success",
    ...
    "nowpayments_cancel_invoice": "danger",
