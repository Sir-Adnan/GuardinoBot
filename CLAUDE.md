...
- **Next (vertical slices):** remaining §9 areas (Resellers, Discounts, Automation/Broadcast, Reports, Settings) + more write actions (create/edit services, renew/add-traffic, balance adjust, payment approve/reject), each a FastAPI router + a Refine page through the adapter.
